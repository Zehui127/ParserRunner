%{
/******************************************************************************
 * Copyright 1995, 2002, 2006, 2011, 2012, 2014, 2017                         *
 *           John Carroll, Guido Minnen, Kevin Humphreys, Oeistein Andersen   *
 *                                                                            *
 ...
 ******************************************************************************
   ...
   line options have to be adapted.
...
ESEDING "es"|"ed"|"ing"
 /* ligatures AE/ae */
ae ae|\xC3\x86|\xC3\xA6
 /* ligatures OE/oe */
oe oe|\xC5\x92|\xC5\x93  
realapostrophe \xE2\x80\x99 
...
<verb,any>{realapostrophe}"ll"  { return(stem(5,"will","")); }
<verb,any>"'m"  { return(stem(2,"be","")); }              /* disprefer */
<verb,any>{realapostrophe}"m"  { return(stem(4,"be","")); }              /* disprefer */
<verb,any>"'re"  { return(stem(3,"be","")); }             /* disprefer */
<verb,any>{realapostrophe}"re"  { return(stem(5,"be","")); }             /* disprefer */
<verb,any>"'ve"  { return(stem(3,"have","")); }
<verb,any>{realapostrophe}"ve"  { return(stem(5,"have","")); }
...
<verb,any>"ski"{realapostrophe}"d"  { return(stem(5,"i","ed")); }          /* en */
...
<noun,any>"K"{realapostrophe}"s" { return(stem(4,"","s")); }
...
<noun,any>"men-o"{realapostrophe}"-war"  { return(stem(11,"an-of-war","s")); } /* disprefer */
...
<verb,any>"ko"{realapostrophe}"d"  { return(stem(5,"o","ed")); }           /* en */
<verb,any>"ko'ing"  { return(stem(4,"","ing")); }        
<verb,any>"ko"{realapostrophe}"ing"  { return(stem(6,"","ing")); }
<verb,any>"ko's"  { return(stem(2,"","s")); }            
<verb,any>"ko"{realapostrophe}"s"  { return(stem(4,"","s")); }
<verb,any>"tally-ho'd"  { return(stem(3,"","ed")); }     /* en */ /* disprefer */
<verb,any>"tally-ho"{realapostrophe}"d"  { return(stem(5,"","ed")); }     /* en */ /* disprefer */
<noun,any>("co"|"do"|"ko"|"no")"'s"   { return(stem(2,"","s")); }
<noun,any>("co"|"do"|"ko"|"no"){realapostrophe}"s"   { return(stem(4,"","s")); }
...
<noun,any>({A}|".")+"."{realapostrophe}"s."               { return(stem(6,".","s")); } /* disprefer */
...
<verb,noun,any>{SKIP}     { ECHO; return(1); }
...
<scan>{realapostrophe}"d"/_VH      { return(stem(4,"have","ed")); }    /* disprefer */
<scan>"'d"/_VM      { return(stem(2,"would","")); }
<scan>{realapostrophe}"d"/_VM      { return(stem(4,"would","")); }
<scan>"'s"/_VBZ     { return(stem(2,"be","s")); }       /* disprefer */
<scan>{realapostrophe}"s"/_VBZ     { return(stem(4,"be","s")); }       /* disprefer */
<scan>"'s"/_VDZ     { return(stem(2,"do","s")); }       /* disprefer */
<scan>{realapostrophe}"s"/_VDZ     { return(stem(4,"do","s")); }       /* disprefer */
<scan>"'s"/_VHZ     { return(stem(2,"have","s")); }     /* disprefer */
<scan>{realapostrophe}"s"/_VHZ     { return(stem(4,"have","s")); }     /* disprefer */
<scan>"'s"/_"$"     { return(stem(2,"'s","")); }             
<scan>{realapostrophe}"s"/_"$"     { return(stem(4,"'s","")); }
<scan>"'s"/_POS     { return(stem(2,"'s","")); }             
<scan>{realapostrophe}"s"/_POS     { return(stem(4,"'s","")); }
<scan>"'s"/_CSA     { return(stem(2,"as","")); }             
<scan>{realapostrophe}"s"/_CSA     { return(stem(4,"as","")); }
<scan>"'s"/_CJS     { return(stem(2,"as","")); }             
<scan>{realapostrophe}"s"/_CJS     { return(stem(4,"as","")); }
...
<scan>"n"{realapostrophe}"t"/_XX     { return(stem(5,"not","")); }       /* disprefer */
...
<scan>({G}|[_<>])+/_      { return(common_noun_stem()); }
<scan>"+"/_       { return(common_noun_stem()); }
<scan>({G}|[_<>]|"+")+/_ { common_noun_stem(); printf("+"); return(1);} /* may not work with morphg */
<scan>_{G}+       { if Option(tag_output) ECHO; return(1); }
<scan>"\n"        { ECHO; fflush(yyout); return(1); }
<scan>{SKIP}      { ECHO; return(1); }
<scan>"<w "[^>]*">"  { ECHO; return(1); }
