...
(defun load-compiled-file (p)
   ...
   #+(or procyon openmcl mcl poplog cormanlisp sbcl clozure) (load p)
   #-(or procyon openmcl mcl poplog cormanlisp sbcl clozure)
...
(dolist (x '("hdr" "tools" "readcirc" "install" "in-text" "ask-stats"
